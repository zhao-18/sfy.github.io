...
self.dotColors = [
    ['rgb(39,76,207)', 'rgba(39,76,207,.3)', 'rgba(39,76,207,.8)'],
    ['rgb(89,143,0)', 'rgba(89,143,0,.3)', 'rgba(89,143,0,.8)'],
];
...
function init() {
    ...
    try {
        ...
        self.lines[0] = new Line(0, canvas.offsetHeight - 100, 'rgb(10,42,157)', self.options, mouse);
        self.lines[1] = new Line(0, canvas.offsetHeight - 100, 'rgb(116,5,5)', self.options, mouse);
